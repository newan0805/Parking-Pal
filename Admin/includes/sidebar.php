<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
            ...
            <li class="<?php if($page=="booking") {echo "active";}?>"><a href="booking.php"><em class="fa fa-toggle-off">&nbsp;</em> Bookings</a></li>
            <li class="<?php if($page=="add_locations") {echo "active";}?>"><a href="add_locations.php"><em class="fa fa-toggle-off">&nbsp;</em>Add Locations</a></li>
			<li class="<?php if($page=="locations") {echo "active";}?>"><a href="locations.php"><em class="fa fa-file">&nbsp;</em> Locations</a></li>
